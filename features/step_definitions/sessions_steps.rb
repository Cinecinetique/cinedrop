...
Given(/^a user is confirmed$/) do
 	@login_details = user_details_for_a("Member")
end
...
Then(/^the user is redirected to the plans page$/) do
  page.current_url.should == "http://localhost:3000/plans"
end
