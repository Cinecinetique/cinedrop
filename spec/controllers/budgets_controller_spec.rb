...
describe BudgetsController do
  ...
  let(:valid_attributes) { { "preprod_cost" => "1.5" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved budget as @budget" do
        ...
        post :create, {:budget => { "preprod_cost" => "invalid value" }}, valid_session
        assigns(:budget).should be_a_new(Budget)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested budget" do
        ...
        Budget.any_instance.should_receive(:update).with({ "preprod_cost" => "1.5" })
        put :update, {:id => budget.to_param, :budget => { "preprod_cost" => "1.5" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the budget as @budget" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Budget.any_instance.stub(:save).and_return(false)
        put :update, {:id => budget.to_param, :budget => { "preprod_cost" => "invalid value" }}, valid_session
        assigns(:budget).should eq(budget)
      end
