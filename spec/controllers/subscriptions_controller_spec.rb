...
describe SubscriptionsController do
  ...
  let(:valid_attributes) { { "start_date" => "2013-11-19 19:36:32" } }
  ...
  describe "GET index" do
    it "assigns all subscriptions as @subscriptions" do
      ...
      assigns(:subscriptions).to_a.should =~ [subscription, subscriptions(:one), subscriptions(:two)]
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved subscription as @subscription" do
        ...
        post :create, {:subscription => { "start_date" => "invalid value" }}, valid_session
        assigns(:subscription).should be_a_new(Subscription)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested subscription" do
        ...
        Subscription.any_instance.should_receive(:update).with({ "start_date" => "2013-11-19 19:36:32" })
        put :update, {:id => subscription.to_param, :subscription => { "start_date" => "2013-11-19 19:36:32" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the subscription as @subscription" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Subscription.any_instance.stub(:save).and_return(false)
        put :update, {:id => subscription.to_param, :subscription => { "start_date" => "invalid value" }}, valid_session
        assigns(:subscription).should eq(subscription)
      end
  ...
  describe "POST payment_notifications" do
    ...
    it "validate authenticity of valid ipn message" do
      ...
      post :payment_notifications, ipn_message
      ...
      IpnMessage.find_by_status("VERIFIED").should_not be_nil
      IpnMessage.find_by_status("INVALID").should be_nil
    ...
    it "mark invalid ipn message that fails paypal validation" do
      ...
      IpnMessage.find_by_status("INVALID").should_not be_nil
      IpnMessage.find_by_status("VERIFIED").should be_nil
    ...
    # it "create a subscription for new subscriber" do
    #   stub_request(:post, "http://localhost:4578/cgi-bin/webscr?cmd=_notify-validate").to_return(:body => "VERIFIED")
    #   post :payment_notifications, ipn_message
    #   response.body.should have_content("")
    #   response.should be_success
    #   Subscription.find_by_recurring_payment_id("dfsadfa77").should_not be_nil
    # end

    it "create instalment for payments"
    it "doesn't create subscription when a subscription already exists"
    it "does nothing if the ipn completion message for a given billing period has already been processed"
  end
